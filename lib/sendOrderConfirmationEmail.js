...
export async function sendOrderConfirmationEmail(sessionData) {
  ...
  if (
    data.personalizations[0].dynamic_template_data.line2 === "null" ||
    data.personalizations[0].dynamic_template_data.line2 === "undefined"
  ) {
  ...
  try {
    ...
    console.error("SendGrid order confirmation failed:", details);
    throw new Error(
